...
func (rf *Raft) readPersist(data []byte) {
	if data == nil || len(data) < 1 { // bootstrap without any state?
		logger.Fatalf("readPersist: Nothing in the state of server %d", rf.me)
		return
	}
	// Your code here (2C).
	// Example:
...
func (rf *Raft) RequestVote(args *RequestVoteArgs, reply *RequestVoteReply) {
	...
	if len(rf.log) == 0 {
		fmt.Printf("RequestVote: server %d case 0 \n", rf.me)
		rf.timeLastOperation = time.Now()
		...
		fmt.Printf("RequestVote: server %d case 1 \n", rf.me)
		rf.timeLastOperation = time.Now()
		...
		fmt.Printf("RequestVote: server %d case 2 \n", rf.me)
		fmt.Printf("             %d before term = %d. votedFor = %d\n", rf.me, rf.currentTerm, rf.votedFor)
		rf.timeLastOperation = time.Now()
...
func (rf *Raft) sendRequestVote(server int, args *RequestVoteArgs, reply *RequestVoteReply) bool {
	...
	if reply.VoteGranted {
		...
		// fmt.Printf("-------------------sendRequestVote failed %d:\n", rf.me)
		// fmt.Printf("                    rf.currentTerm = %d. rf.votedFor = %d\n", rf.currentTerm, rf.votedFor)
		rf.persist()
	}
...
func Make(peers []*labrpc.ClientEnd, me int,
	...
	fmt.Printf("Invoking Make() for server %d\n", me)
	rf := &Raft{}
	rf.peers = peers
